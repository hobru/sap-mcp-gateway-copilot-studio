...
2. Upload the OpenAPI spec: [`swapi-openapi-301.yaml`](../openapi/swapi-openapi-301.yaml) (in the `openapi/` folder).
...
The OpenAPI spec used to generate the MCP tools is included here: [`swapi-openapi-301.yaml`](../openapi/swapi-openapi-301.yaml).
