...
| 7 | [Business Partner updates through an OData API artifact](./guides/07-business-partner-updates.md) | Use a URL-based OData receiver with stored backend credentials and automatic **CSRF-token handling**, prove GET + PATCH, then expose both as MCP tools | Real user at the gateway; dedicated **SAP communication user** in the backend | [▶️ watch](https://www.youtube.com/watch?v=jP9r2HfOgyI) |
